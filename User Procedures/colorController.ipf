...
Window colorScaleController() : Panel
	...
	NewPanel /W=(696,185,1129,369) as "Color Scale Controller"
	...
	Slider lastColorController,limits={0,1,0},value= 0.024822695035461,vert= 0,ticks= 0
	Slider firstColorController,pos={110,50},size={300,29},proc=adjustColor
	Slider firstColorController,limits={0,1,0},value= 0,vert= 0,ticks= 0
	...
	PopupMenu colorTable,mode=8,value= #"\"*COLORTABLEPOP*\""
EndMacro
